...
public class MaquinasPanel extends JPanel {
    ...
    public MaquinasPanel() {
        ...
        // Adicionando um MouseListener para detectar clique duplo
        maquinasTable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) { // Detecta clique duplo
                    ...
                    if (selectedRow != -1) {
                        editMaquina(selectedRow); // Chama o método para editar a máquina
                    }
                }
            }
        });
    ...
    private void editMaquina(int selectedRow) {
        ...
        JTextField txtDataAquisicao = new JTextField(dataAquisicao.toString()); // Formato "yyyy-MM-dd"
